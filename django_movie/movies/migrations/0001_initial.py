# Generated by Django 4.2.1 on 2023-06-01 10:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('height', models.DecimalField(decimal_places=2, max_digits=3, null=True, verbose_name='Зріст')),
                ('native_country', models.CharField(max_length=100, null=True, verbose_name='Місто народження')),
            ],
            options={
                'verbose_name': 'Людина',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=20, verbose_name='Стать')),
            ],
        ),
        migrations.CreateModel(
            name='Genre',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genres', models.ManyToManyField(related_name='film_genres', to='movies.Genre', verbose_name='Жанри')),
                ...
                ('scenarists', models.ManyToManyField(related_name='film_scenarist', to='movies.Actor', verbose_name='Сценарій')),
            ],
            options={
                'verbose_name': 'Фільм',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='movies.reviews', verbose_name='Батьки')),
            ],
            options={
                'verbose_name': 'Стать',
        ...
        migrations.AddField(
            model_name='actor',
            name='gender',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies.gender', verbose_name='Стать'),
        ),
        migrations.AddField(
            model_name='actor',
            name='genres',
            field=models.ManyToManyField(related_name='film_genre', to='movies.Genre', verbose_name='Жанри'),
        ),
        migrations.AddField(
            model_name='actor',
            name='married',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='wife_or_husband', to='movies.actor', verbose_name='Шлюб'),
        ),
    ]
